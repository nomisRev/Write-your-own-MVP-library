...
"$PROJECT_DIR"/gradlew --no-daemon --info assemble -PdisablePreDex -PwithDexcount -Dscan
"$PROJECT_DIR"/gradlew --no-daemon --info test connectedAndroidTest -PdisablePreDex -PwithDexcount